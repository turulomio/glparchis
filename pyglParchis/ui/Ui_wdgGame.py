...
class Ui_wdgGame(object):
    def setupUi(self, wdgGame):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/glparchis/game4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabHS.addTab(self.tab_5, icon7, "")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/glparchis/game6.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabHS.addTab(self.tab_3, icon8, "")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/glparchis/game8.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabHS.addTab(self.tab_4, icon9, "")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/glparchis/corona.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tab.addTab(self.tab_2, icon10, "")
