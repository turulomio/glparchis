...
class i18n(QObject):
    ...
    def changelog(self, language):
        ...
        f.write("- {}\n".format(self.tr("Added automatism to pawns when only one can move")))
        f.write("\n")
        ...
        f.write("- {}\n".format(self.tr("Anadidas estadisticas individuales de juego")))
        f.write("- {}\n".format(self.tr("El distribuible de windows se ha cambiado por un msi. Desinstale el antiguo glparchis antes de instalar el nuevo")))
        f.write("\n")
