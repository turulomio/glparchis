...
class Ui_frmShowFicha(object):
    def setupUi(self, frmShowFicha):
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=frmShowFicha)
        ...
        self.lblFicha = QtWidgets.QLabel(parent=self.tab)
        self.lblFicha.setText("")
        self.lblFicha.setPixmap(QtGui.QPixmap(":/glparchis/fichaamarilla.png"))
        self.lblFicha.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblFicha.setObjectName("lblFicha")
        self.verticalLayout.addWidget(self.lblFicha)
        self.lblJugador = QtWidgets.QLabel(parent=self.tab)
        self.lblJugador.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblJugador.setObjectName("lblJugador")
        self.verticalLayout.addWidget(self.lblJugador)
        self.lblRuta = QtWidgets.QLabel(parent=self.tab)
        self.lblRuta.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.tblAmenazas = QtWidgets.QTableWidget(parent=self.tab_2)
        ...
        self.cmbDestino = QtWidgets.QComboBox(parent=self.tab_3)
        self.cmbDestino.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToContents)
        ...
        self.group = QtWidgets.QGroupBox(parent=self.tab_3)
        self.group.setObjectName("group")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.group)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.tblAmenazasDestino = QtWidgets.QTableWidget(parent=self.group)
