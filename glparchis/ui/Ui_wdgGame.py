...
class Ui_wdgGame(object):
    def setupUi(self, wdgGame):
        ...
        self.splitter = QtWidgets.QSplitter(parent=wdgGame)
        self.splitter.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        self.layPanel.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetMinimumSize)
        self.layPanel.setContentsMargins(0, 0, 0, 0)
        self.layPanel.setObjectName("layPanel")
        self.cmdTirarDado = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.panelScroll = QtWidgets.QScrollArea(parent=self.layoutWidget)
        self.panelScroll.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        ...
        self.chkAvanza = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.tab = QtWidgets.QTabWidget(parent=self.layoutWidget_2)
        ...
        self.tab.setTabPosition(QtWidgets.QTabWidget.TabPosition.East)
        ...
        self.ogl = wdgOGL(parent=self.tabGame)
        self.ogl.setSizeIncrement(QtCore.QSize(10, 10))
        self.ogl.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.ogl.setObjectName("ogl")
        self.gridLayout.addWidget(self.ogl, 0, 0, 1, 1)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/glparchis/keko.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.table = QTableStatistics(parent=self.tabStatistics)
        ...
        item = QtWidgets.QTableWidgetItem()
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/glparchis/cube1.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon1)
        self.table.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/glparchis/cube2.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon2)
        self.table.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/glparchis/cube3.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon3)
        self.table.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/glparchis/cube4.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon4)
        self.table.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/glparchis/cube5.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon5)
        self.table.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/glparchis/cube6.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon6)
        ...
        self.lblTime = QtWidgets.QLabel(parent=self.tabStatistics)
        ...
        self.tabHS = QtWidgets.QTabWidget(parent=self.tab_2)
        self.tabHS.setTabPosition(QtWidgets.QTabWidget.TabPosition.North)
        self.tabHS.setObjectName("tabHS")
        self.tab_6 = QtWidgets.QWidget()
        self.tab_6.setObjectName("tab_6")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.tab_6)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.tblHighScores3 = QtWidgets.QTableWidget(parent=self.tab_6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/glparchis/game3.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.tblHighScores4 = QtWidgets.QTableWidget(parent=self.tab_5)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/glparchis/game4.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.tabHS.addTab(self.tab_5, icon8, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.tab_3)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.tblHighScores6 = QtWidgets.QTableWidget(parent=self.tab_3)
        self.tblHighScores6.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.tblHighScores6.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.tblHighScores8 = QtWidgets.QTableWidget(parent=self.tab_4)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/glparchis/corona.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
