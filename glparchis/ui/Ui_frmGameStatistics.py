...
class Ui_frmGameStatistics(object):
    def setupUi(self, frmGameStatistics):
        ...
        frmGameStatistics.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        frmGameStatistics.resize(991, 798)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/glparchis/statistics.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lblApp = QtWidgets.QLabel(parent=frmGameStatistics)
        font = QtGui.QFont()
        ...
        self.lblPixmap = QtWidgets.QLabel(parent=frmGameStatistics)
        ...
        self.tab = QtWidgets.QTabWidget(parent=frmGameStatistics)
        ...
        self.webInstallation = QtWebEngineWidgets.QWebEngineView(parent=self.tabGLParchis)
        ...
        self.webWorld = QtWebEngineWidgets.QWebEngineView(parent=self.tabLicense)
        ...
        self.lblUUID = QtWidgets.QLabel(parent=frmGameStatistics)
