...
class Ui_wdgUserPanel(object):
    def setupUi(self, wdgUserPanel):
        ...
        self.grp = QtWidgets.QGroupBox(parent=wdgUserPanel)
        ...
        self.lblAvatar = QtWidgets.QLabel(parent=self.grp)
        ...
        self.lblAvatar.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.lst = QtWidgets.QListWidget(parent=self.grp)
        ...
        self.chk = QtWidgets.QCheckBox(parent=self.grp)
