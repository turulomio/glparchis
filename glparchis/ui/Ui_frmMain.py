...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        frmMain.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.menuJugar = QtWidgets.QMenu(parent=self.menuBar)
        ...
        self.actionSalir = QtGui.QAction(parent=frmMain)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/glparchis/exit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSalir.setIcon(icon1)
        self.actionSalir.setObjectName("actionSalir")
        self.actionAcercaDe = QtGui.QAction(parent=frmMain)
        self.actionAcercaDe.setIcon(icon)
        self.actionAcercaDe.setObjectName("actionAcercaDe")
        self.actionRecuperarPartida = QtGui.QAction(parent=frmMain)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/glparchis/open.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRecuperarPartida.setIcon(icon2)
        self.actionRecuperarPartida.setObjectName("actionRecuperarPartida")
        self.actionGuardarPartida = QtGui.QAction(parent=frmMain)
        self.actionGuardarPartida.setEnabled(False)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/glparchis/save.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionGuardarPartida.setIcon(icon3)
        self.actionGuardarPartida.setObjectName("actionGuardarPartida")
        self.actionPartidaNueva4 = QtGui.QAction(parent=frmMain)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/glparchis/game4.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/glparchis/configure.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSettings.setIcon(icon5)
        self.actionSettings.setObjectName("actionSettings")
        self.actionHelp = QtGui.QAction(parent=frmMain)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/glparchis/help.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionHelp.setIcon(icon6)
        self.actionHelp.setObjectName("actionHelp")
        self.actionUpdates = QtGui.QAction(parent=frmMain)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/glparchis/update.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionUpdates.setIcon(icon7)
        self.actionUpdates.setObjectName("actionUpdates")
        self.actionSound = QtGui.QAction(parent=frmMain)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/glparchis/sound.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSound.setIcon(icon8)
        self.actionSound.setObjectName("actionSound")
        self.actionPartidaNueva6 = QtGui.QAction(parent=frmMain)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/glparchis/game6.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPartidaNueva6.setIcon(icon9)
        self.actionPartidaNueva6.setObjectName("actionPartidaNueva6")
        self.actionPartidaNueva8 = QtGui.QAction(parent=frmMain)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/glparchis/game8.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPartidaNueva8.setIcon(icon10)
        self.actionPartidaNueva8.setObjectName("actionPartidaNueva8")
        self.actionFullScreen = QtGui.QAction(parent=frmMain)
        self.actionFullScreen.setCheckable(True)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/glparchis/fullscreen.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionFullScreen.setIcon(icon11)
        self.actionFullScreen.setObjectName("actionFullScreen")
        self.actionMundialStatistics = QtGui.QAction(parent=frmMain)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/glparchis/statistics.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionMundialStatistics.setIcon(icon12)
        self.actionMundialStatistics.setObjectName("actionMundialStatistics")
        self.actionAcercarTablero = QtGui.QAction(parent=frmMain)
        self.actionAcercarTablero.setEnabled(False)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/glparchis/zoom-in.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAcercarTablero.setIcon(icon13)
        self.actionAcercarTablero.setObjectName("actionAcercarTablero")
        self.actionAlejarTablero = QtGui.QAction(parent=frmMain)
        self.actionAlejarTablero.setEnabled(False)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/glparchis/zoom-out.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAlejarTablero.setIcon(icon14)
        self.actionAlejarTablero.setObjectName("actionAlejarTablero")
        self.actionPartidaNueva3 = QtGui.QAction(parent=frmMain)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/glparchis/game3.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPartidaNueva3.setIcon(icon15)
        self.actionPartidaNueva3.setObjectName("actionPartidaNueva3")
        self.actionReportBug = QtGui.QAction(parent=frmMain)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/glparchis/reportbug.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionReportBug.setIcon(icon16)
        self.actionReportBug.setObjectName("actionReportBug")
        self.actionAutomatism = QtGui.QAction(parent=frmMain)
        self.actionAutomatism.setCheckable(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/glparchis/play.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAutomatism.setIcon(icon17)
        self.actionAutomatism.setObjectName("actionAutomatism")
        self.actionLeftPanel = QtGui.QAction(parent=frmMain)
        self.actionLeftPanel.setCheckable(True)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/glparchis/panel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
