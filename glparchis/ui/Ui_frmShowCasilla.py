...
class Ui_frmShowCasilla(object):
    def setupUi(self, frmShowCasilla):
        ...
        self.lblCasilla = QtWidgets.QLabel(parent=frmShowCasilla)
        self.lblCasilla.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblCasilla.setObjectName("lblCasilla")
        self.verticalLayout.addWidget(self.lblCasilla)
        self.lblMaxCasillas = QtWidgets.QLabel(parent=frmShowCasilla)
        self.lblMaxCasillas.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblMaxCasillas.setObjectName("lblMaxCasillas")
        self.verticalLayout.addWidget(self.lblMaxCasillas)
        self.lblSeguro = QtWidgets.QLabel(parent=frmShowCasilla)
        self.lblSeguro.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblSeguro.setObjectName("lblSeguro")
        self.verticalLayout.addWidget(self.lblSeguro)
        self.grp = QtWidgets.QGroupBox(parent=frmShowCasilla)
        self.grp.setObjectName("grp")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.grp)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.lbl1 = QtWidgets.QLabel(parent=self.grp)
        self.lbl1.setText("")
        ...
        self.lbl2 = QtWidgets.QLabel(parent=self.grp)
        self.lbl2.setText("")
        ...
        self.lbl3 = QtWidgets.QLabel(parent=self.grp)
        self.lbl3.setText("")
        self.lbl3.setPixmap(QtGui.QPixmap(":/glparchis/fichaamarilla.png"))
        self.lbl3.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lbl3.setObjectName("lbl3")
        self.horizontalLayout.addWidget(self.lbl3)
        self.lbl4 = QtWidgets.QLabel(parent=self.grp)
        self.lbl4.setText("")
