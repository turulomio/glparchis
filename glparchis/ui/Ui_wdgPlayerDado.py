...
class Ui_wdgPlayerDado(object):
    def setupUi(self, wdgPlayerDado):
        ...
        self.frame = QtWidgets.QFrame(parent=wdgPlayerDado)
        ...
        self.lblDado = QtWidgets.QLabel(parent=self.frame)
        ...
        self.lblDado.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
